		...
		widgets = {
			...
			-- Priority Level Settings
			{
				...
				sub_widgets = {
					-- Boss Enemies (Priority 1 - Fixed to include all bosses)
					{
						...
						options = {
							...
							{text = "priority_disabled", value = "disabled"}
										...
										{
						setting_id = "priority_chaos_ogryn_houndmaster",
						type = "dropdown",
						default_value = "high",
						options = {
							{text = "priority_high", value = "high"},
					...
					{
						setting_id = "priority_chaos_armored_hound",
						type = "dropdown",
						default_value = "high",
						options = {
							{text = "priority_high", value = "high"},
					...
					-- Medium Priority Enemies (Elites)
					{
						...
						options = {
							...
							{text = "priority_disabled", value = "disabled"}
										...
										{
						setting_id = "priority_renegade_plasma_gunner",
						type = "dropdown",
						default_value = "medium",
						options = {
							{text = "priority_high", value = "high"},
			...
			},
			{
				...
				show_widget = function() return mod:get("filter_mode") == "custom" end
						...
						{
				setting_id = "tag_chaos_armored_hound",
				type = "checkbox",
				default_value = true,
				show_widget = function() return mod:get("filter_mode") == "custom" end
			},
			...
			},
			{
				...
				show_widget = function() return mod:get("filter_mode") == "custom" end
						...
						{
				setting_id = "tag_renegade_plasma_gunner",
				type = "checkbox",
				default_value = true,
				show_widget = function() return mod:get("filter_mode") == "custom" end
			},
			...
			},
			{
				...
				show_widget = function() return mod:get("filter_mode") == "custom" end
						...
						{
				setting_id = "tag_chaos_ogryn_houndmaster",
				type = "checkbox",
				default_value = true,
				show_widget = function() return mod:get("filter_mode") == "custom" end
			},
