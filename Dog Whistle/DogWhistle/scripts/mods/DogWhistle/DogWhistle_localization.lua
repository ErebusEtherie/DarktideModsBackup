...
local localization = {
    ...
    type_tooltip = {
        en = string.format(
            crayon("This setting only applies to the Arbitrator/Skitarius class.", "terminal_text_header_disabled").."\n"..
    ...
    dog_tag = {
        en = Localize("loc_interface_setting_companion_tag_in_mission"),
    },
    standard_tag = {
        en = "Standard Tag",
        ["zh-cn"] = "普通标记",
    ...
    ignore_marked_tooltip = {
        en = string.format("If enabled, the mod will not target enemies which already have been marked by another Companion.\n"..
    ...
    type_priority_tooltip = {
        en = string.format(
            crayon("This setting only applies to the Arbitrator/Skitarius class.", "terminal_text_header_disabled").."\n"..
            crayon(Localize("loc_interface_setting_companion_tag_in_mission"),"terminal_text_body_sub_header")..": The mod will always allow " .. Localize("loc_interface_setting_companion_tag_in_mission") .. " Commands to override Standard Tags, regardless of other settings.\n"..
            crayon("Standard Tag","terminal_text_body_sub_header")..": The mod will allow Standard Tags to override " .. Localize("loc_interface_setting_companion_tag_in_mission") .. " Commands, regardless of other settings.\n"..
    ...
    -- └─┘┴ ┴└─┘┴─┘┴─┘
    skull_settings = {
        en = Localize("loc_talent_cryptic_servo_skull") .. " Settings",
        ["zh-cn"] = Localize("loc_talent_cryptic_servo_skull") .. " 设置",
        ["zh-tw"] = Localize("loc_talent_cryptic_servo_skull") .. " 設定",
    },
    skull_retarget_cd = {
        en = Localize("loc_talent_cryptic_servo_skull") .. " Retargeting Cooldown",
        ["zh-cn"] = Localize("loc_talent_cryptic_servo_skull") .. " 重新标记冷却时间",
        ["zh-tw"] = Localize("loc_talent_cryptic_servo_skull") .. " 重新標記冷卻時間",
    },
    skull_retarget_cd_tooltip = {
        en = "Minimum time in seconds before allowing the " .. Localize('loc_talent_cryptic_servo_skull') .. " to retarget the same enemy. Set to 0 to disable."
    },
    skull_cap_minimum = {
        en = Localize("loc_talent_cryptic_servo_skull") .. " Minimum Capacitance",
        ["zh-cn"] = Localize("loc_talent_cryptic_servo_skull") .. " 电容层数最小值",
        ["zh-tw"] = Localize("loc_talent_cryptic_servo_skull") .. " 電容層數最小值",
    },
    skull_cap_minimum_tooltip = {
        en = string.format("Minimum percentage of Capacitance required for %s to be commanded.\nEach full stack of Capacitance is equal to 100.", Localize("loc_talent_cryptic_servo_skull"))
    },
    ...
    unique_settings = {
       en = Localize("loc_settings_menu_group_other_settings")
    },
    skull_hack = {
        en = Localize("loc_objective_psykhanium_decode_01_header")
    },
    elite_breeds = {
        en = "Elites",
        ["zh-cn"] = "精英",
    ...
    other_archetype_tooltip = {
        en = "When enabled, the mod's functionality will also be applied to standard tagging for non-Companion classes.",
