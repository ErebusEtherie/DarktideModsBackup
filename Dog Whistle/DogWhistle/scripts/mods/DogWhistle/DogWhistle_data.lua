...
local widgets = {
    ...
    },
    {
        ...
        sub_widgets = {
            ...
            {
                setting_id    = "reset_cooldown_on_kill",
                type          = "checkbox",
                default_value = true,
            },
            {
    ...
    {
        setting_id  = "skull_settings",
        type        = "group",
        sub_widgets = {
            {
				setting_id = "skull_retarget_cd",
				type          = "numeric",
                default_value = 0,
                range         = {0, 10},
				tooltip = "skull_retarget_cd_tooltip",
			},
            {
				setting_id = "skull_cap_minimum",
				type          = "numeric",
                default_value = 0,
                range         = {0, 500},
				tooltip = "skull_cap_minimum_tooltip",
			},
        }
    },
    {
    ...
    {
        setting_id  = "unique_settings",
        type        = "group",
        sub_widgets = {
            {
                setting_id = "skull_hack",
                type       = "checkbox",
                default_value = false,
            },
        }
