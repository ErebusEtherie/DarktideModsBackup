...
local view_settings = {
	...
	spawn_multiplier_size = { 270, 50 },
	spawn_multiplier_setting_width = 104,
	spawn_multiplier_minimum = 1,
	spawn_multiplier_maximum = 5,
	spawn_multiplier_default = 1,
	spawn_multiplier_ids = {
		"spawn_multiplier_common",
		"spawn_multiplier_elite",
		"spawn_multiplier_special",
		"spawn_multiplier_boss",
	},
	spawn_multiplier_label_loc_keys = {
		spawn_multiplier_common = "spawn_multiplier_common",
		spawn_multiplier_elite = "spawn_multiplier_elite",
		spawn_multiplier_special = "spawn_multiplier_special",
		spawn_multiplier_boss = "spawn_multiplier_boss",
	},
	dropdown_size = { 510, 52 },
	dropdown_setting_width = 510,
	...
	dropdown_all_ids = {
		...
		"havoc_faction",
		"havoc_mission_giver",
		"havoc_add_circumstance",
		"havoc_remove_circumstance",
	...
	dropdown_label_loc_keys = {
		...
		havoc_add_circumstance = "label_add_havoc_circumstance",
		havoc_remove_circumstance = "label_remove_havoc_circumstance",
	...
	dropdown_setting_keys = {
		...
		havoc_add_circumstance = "havoc_add_circumstance",
		havoc_remove_circumstance = "havoc_remove_circumstance",
	...
	dropdown_setting_default = {
		...
		havoc_add_circumstance = "default",
		havoc_remove_circumstance = "default",
