...
local toggle_FP_buff_handling = toggle_FP_buff_handling
local toggle_SCD_buff_handling = toggle_SCD_buff_handling
local toggle_HCC_buff_handling = toggle_HCC_buff_handling
local toggle_TDI_buff_handling = toggle_TDI_buff_handling
local toggle_GMA_buff_handling = toggle_GMA_buff_handling
local toggle_CD_buff_handling = toggle_CD_buff_handling
...
local cryptic_buff_templates
pcall(function()
    cryptic_buff_templates = require("scripts/settings/buff/archetype_buff_templates/cryptic_buff_templates")
end)

local broker_buff_templates
pcall(function()
    broker_buff_templates = require("scripts/settings/buff/archetype_buff_templates/broker_buff_templates")
end)

local adamant_buff_templates
pcall(function()
    adamant_buff_templates = require("scripts/settings/buff/archetype_buff_templates/adamant_buff_templates")
end)
...
local mod_buffs_table = {
    ...
    ----------------- Cryptic Archetype Buffs
    FP_dissector = {
        template_name = "cryptic_dissector_stack",
        talent_name = "cryptic_dissector",
        buff_name = "Flensing Protocols",
        max_stacks = 8,
        desired_stacks = "desired_FP_stacks",
        toggle_var = "toggle_FP_buff_handling"
    },



    SCD_permastack = {
        template_name = "cryptic_overload_keystone_triggered_counter",
        talent_name = "cryptic_overload_keystone_permastack",
        buff_name = "Static Capacitor Drain",
        max_stacks = 24,
        desired_stacks = "desired_SCD_stacks",
        toggle_var = "toggle_SCD_buff_handling"
    },

    KP_permastack = {
        template_name = "adamant_execution_order_permastack",
        talent_name = "adamant_execution_order_permastack",
        buff_name = "Keeping Protocol",
        max_stacks = 30,
        desired_stacks = "desired_KP_stacks",
        toggle_var = "toggle_KP_buff_handling"
    },

    adamant_forceful_stacks = {
        template_name = "adamant_forceful_stacks",
        talent_name = "adamant_forceful",
        buff_name = "Forceful Stacks",
        base_duration = adamant_buff_templates and adamant_buff_templates.adamant_forceful_stacks and adamant_buff_templates.adamant_forceful_stacks.duration or 5,
        max_stacks = 10,
        desired_stacks = 10,
        toggle_var = "toggle_Forceful_buff_handling"
    },

    broker_chemical_dependency_stacks = {
        template_name = "broker_keystone_chemical_dependency_stack",
        talent_name = "broker_keystone_chemical_dependency",
        buff_name = "Chemical Dependency",
        base_duration = broker_buff_templates and broker_buff_templates.broker_keystone_chemical_dependency_stack and broker_buff_templates.broker_keystone_chemical_dependency_stack.duration or 15,
        max_stacks = 3, -- dynamically adjusted in Add_Buff to 4 when sub_3 is equipped
        desired_stacks = 4,
        toggle_var = "toggle_CD_buff_handling"
    },

    HCC_melee = {
        template_name = "cryptic_hybrid_melee_damage_buff",
        talent_name = "cryptic_hybrid_damage",
        buff_name = "Hybrid Combat Covenant Melee",
        base_duration = cryptic_buff_templates and cryptic_buff_templates.cryptic_hybrid_melee_damage_buff and cryptic_buff_templates.cryptic_hybrid_melee_damage_buff.duration or 5.0,
        max_stacks = cryptic_buff_templates and cryptic_buff_templates.cryptic_hybrid_melee_damage_buff and cryptic_buff_templates.cryptic_hybrid_melee_damage_buff.max_stacks or 5,
        desired_stacks = 5,
        toggle_var = "toggle_HCC_buff_handling"
    },
    HCC_ranged = {
        template_name = "cryptic_hybrid_ranged_damage_buff",
        talent_name = "cryptic_hybrid_damage",
        buff_name = "Hybrid Combat Covenant Ranged",
        base_duration = cryptic_buff_templates and cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff and cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff.duration or 5.0,
        max_stacks = cryptic_buff_templates and cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff and cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff.max_stacks or 5,
        desired_stacks = 5,
        toggle_var = "toggle_HCC_buff_handling"
    },
    TDI_tdr = {
        template_name = "cryptic_ranged_kills_tdr_stack",
        talent_name = "cryptic_ranged_kills_tdr",
        buff_name = "Threat Detection Imperative",
        base_duration = cryptic_buff_templates and cryptic_buff_templates.cryptic_ranged_kills_tdr_stack and cryptic_buff_templates.cryptic_ranged_kills_tdr_stack.duration or 10.0,
        max_stacks = cryptic_buff_templates and cryptic_buff_templates.cryptic_ranged_kills_tdr_stack and cryptic_buff_templates.cryptic_ranged_kills_tdr_stack.max_stacks or 5,
        desired_stacks = 5,
        toggle_var = "toggle_TDI_buff_handling"
    },
    GMA_damage = {
        template_name = "cryptic_elite_kills_damage_stack",
        talent_name = "cryptic_elite_kills_damage",
        buff_name = "Galvanic Marking Array",
        base_duration = cryptic_buff_templates and cryptic_buff_templates.cryptic_elite_kills_damage_stack and cryptic_buff_templates.cryptic_elite_kills_damage_stack.duration or 10.0,
        max_stacks = cryptic_buff_templates and cryptic_buff_templates.cryptic_elite_kills_damage_stack and cryptic_buff_templates.cryptic_elite_kills_damage_stack.max_stacks or 5,
        desired_stacks = 5,
        toggle_var = "toggle_GMA_buff_handling"
    } 
    -- Until_Death = {
...
local set_toggle_variables = function()
    ...
    toggle_FP_buff_handling = mod:get("toggle_FP_buff_handling")
    toggle_SCD_buff_handling = mod:get("toggle_SCD_buff_handling")
    toggle_HCC_buff_handling = mod:get("toggle_HCC_buff_handling")
    toggle_TDI_buff_handling = mod:get("toggle_TDI_buff_handling")
    toggle_GMA_buff_handling = mod:get("toggle_GMA_buff_handling")
    toggle_KP_buff_handling = mod:get("toggle_KP_buff_handling")
    toggle_Forceful_buff_handling = mod:get("toggle_Forceful_buff_handling")
    toggle_CD_buff_handling = mod:get("toggle_CD_buff_handling")
end
...
mod.set_infinite_buffs_update_func = function()
    ...
    for i = 1, #effected_buffs_table do
        ...
        if cryptic_buff_templates then
            if effected_buffs_table[i] == "cryptic_hybrid_melee_damage_buff" and cryptic_buff_templates.cryptic_hybrid_melee_damage_buff then
                cryptic_buff_templates.cryptic_hybrid_melee_damage_buff.duration = 99999
            end
            if effected_buffs_table[i] == "cryptic_hybrid_ranged_damage_buff" and cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff then
                cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff.duration = 99999
            end
            if effected_buffs_table[i] == "cryptic_ranged_kills_tdr_stack" and cryptic_buff_templates.cryptic_ranged_kills_tdr_stack then
                cryptic_buff_templates.cryptic_ranged_kills_tdr_stack.duration = 99999
            end
            if effected_buffs_table[i] == "cryptic_elite_kills_damage_stack" and cryptic_buff_templates.cryptic_elite_kills_damage_stack then
                cryptic_buff_templates.cryptic_elite_kills_damage_stack.duration = 99999
            end
        end
        if adamant_buff_templates then
            if effected_buffs_table[i] == "adamant_forceful_stacks" and adamant_buff_templates.adamant_forceful_stacks then
                adamant_buff_templates.adamant_forceful_stacks.duration = 99999
            end
        end
        if broker_buff_templates then
            if effected_buffs_table[i] == "broker_keystone_chemical_dependency_stack" and broker_buff_templates.broker_keystone_chemical_dependency_stack then
                broker_buff_templates.broker_keystone_chemical_dependency_stack.duration = 99999
            end
        end
    end
end
...
mod.reset_buff_durations = function()
    for i = 1, #mod_buffs_name_table do
        ...
        if cryptic_buff_templates then
            if mod_buffs_name_table[i] == "cryptic_hybrid_melee_damage_buff" and cryptic_buff_templates.cryptic_hybrid_melee_damage_buff then
                cryptic_buff_templates.cryptic_hybrid_melee_damage_buff.duration = mod_buffs_table["HCC_melee"].base_duration
            end
            if mod_buffs_name_table[i] == "cryptic_hybrid_ranged_damage_buff" and cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff then
                cryptic_buff_templates.cryptic_hybrid_ranged_damage_buff.duration = mod_buffs_table["HCC_ranged"].base_duration
            end
            if mod_buffs_name_table[i] == "cryptic_ranged_kills_tdr_stack" and cryptic_buff_templates.cryptic_ranged_kills_tdr_stack then
                cryptic_buff_templates.cryptic_ranged_kills_tdr_stack.duration = mod_buffs_table["TDI_tdr"].base_duration
            end
            if mod_buffs_name_table[i] == "cryptic_elite_kills_damage_stack" and cryptic_buff_templates.cryptic_elite_kills_damage_stack then
                cryptic_buff_templates.cryptic_elite_kills_damage_stack.duration = mod_buffs_table["GMA_damage"].base_duration
            end
        end
        if adamant_buff_templates then
            if mod_buffs_name_table[i] == "adamant_forceful_stacks" and adamant_buff_templates.adamant_forceful_stacks then
                adamant_buff_templates.adamant_forceful_stacks.duration = mod_buffs_table["adamant_forceful_stacks"].base_duration
            end
        end
        if broker_buff_templates then
            if mod_buffs_name_table[i] == "broker_keystone_chemical_dependency_stack" and broker_buff_templates.broker_keystone_chemical_dependency_stack then
                broker_buff_templates.broker_keystone_chemical_dependency_stack.duration = mod_buffs_table["broker_chemical_dependency_stacks"].base_duration
            end
        end
    end
end
...
mod.Reset_Character = function(self)
    ...
    if local_player_unit and is_valid_game_mode() and is_server() then
        ...
        if toggle_buff_handling == true then
            ...
            for i = #player_buffs, 1, -1 do
                if player_buffs[i] then
...
mod.Add_Buff = function(self, buff_name)  
  ...
  ------------------------------------------  
    ...
    if buff_name == "broker_keystone_chemical_dependency_stack" then
        local extra_chem = check_talent_is_equipped(local_player_unit, "broker_keystone_chemical_dependency_sub_3")
        if extra_chem then
            buff_max_stacks = 4
        else
            buff_max_stacks = 3
    ...
    if buff_name == "zealot_fanatic_rage" then
        ...
        local _fanatic_rage_add_stack = function(template_data, template_context)
            ...
            local local_unit_data_ext = ScriptUnit.has_extension(local_player_unit, "unit_data_system")
            template_data.talent_resource_component = local_unit_data_ext and local_unit_data_ext:write_component("talent_resource")
        end
       
        if blazing_piety and player_buffs[blazing_piety] then
    ...
    elseif buff_name == "cryptic_dissector_stack" then
        local manager_buff = nil
        for i = 1, #player_buffs do
            if player_buffs[i]:template_name() == "cryptic_dissector" then
                manager_buff = player_buffs[i]
                break
            end
        end

        if manager_buff then
            local template_data = manager_buff:template_data()
            if template_data.buff_stacks_index then
                table.clear(template_data.buff_stacks_index)
                for i = 1, buff_applied_stacks do
                    local _, new_index = buff_extension:add_externally_controlled_buff("cryptic_dissector_stack", t)
                    table.insert(template_data.buff_stacks_index, new_index)
                end
                
                local current_buffs = buff_extension:buffs(local_player_unit)
                for i = 1, #current_buffs do
                    if current_buffs[i]:template_name() == "cryptic_dissector_stack" then
                        added_buff = i
                    end
                end
                if added_buff then
                    current_buffs[added_buff]._template.duration = buff_duration
                end
            end
        else
        ...
        if player_buffs[added_buff] then
            player_buffs[added_buff]._template.duration = buff_duration  
        end
    end
...
mod.Remove_Buff = function(self, buff_name)
    ...
    elseif buff_name == "cryptic_dissector_stack" then
        local manager_buff = nil
        for i = 1, #buffs do
            if buffs[i]:template_name() == "cryptic_dissector" then
                manager_buff = buffs[i]
                break
            end
        end
        ...
        if manager_buff then
            local template_data = manager_buff:template_data()
            if template_data.buff_stacks_index then
                for i = #template_data.buff_stacks_index, 1, -1 do
                    local buff_index_to_remove = template_data.buff_stacks_index[i]
                    if buff_extension:has_running_buff_with_index(buff_index_to_remove) then
                        buff_extension:remove_externally_controlled_buff(buff_index_to_remove)
                    end
                end
                table.clear(template_data.buff_stacks_index)
            end
        end
    elseif buff_name == "adamant_execution_order_permastack" then
        for i = 1, #buffs do
            if buffs[i]:template_name() == "adamant_execution_order_permastack" then
                buffs[i]:force_finish()
            end
        end
        ...
        if buffs_by_index then
            ...
            for index, buff in pairs(buffs_by_index) do
                if buff:template_name() == "adamant_execution_order_permastack" then
                    table.insert(indices_to_remove, index)
                end
            end
            for _, index in ipairs(indices_to_remove) do
                if buff_extension._buffs_by_index[index] then
                    buff_extension:_remove_internally_controlled_buff(index)
                end
            end
        end
    elseif buff_name == "cryptic_overload_keystone_triggered_counter" then
        for i = 1, #buffs do
            if buffs[i]:template_name() == "cryptic_overload_keystone_triggered_counter" then
                buffs[i]:force_finish()
            end
        end
        local buffs_by_index = buff_extension._buffs_by_index
        if buffs_by_index then
            local indices_to_remove = {}
            for index, buff in pairs(buffs_by_index) do
                if buff:template_name() == "cryptic_overload_keystone_triggered_counter" then
                    table.insert(indices_to_remove, index)
                end
            end
            for _, index in ipairs(indices_to_remove) do
    ...
    elseif buff_name == "adamant_forceful_stacks" then
        for i = 1, #buffs do
            if buffs[i]:template_name() == "adamant_forceful_stacks" then
                buffs[i]:force_finish()
            end
        end
        local buffs_by_index = buff_extension._buffs_by_index
        if buffs_by_index then
            local indices_to_remove = {}
            for index, buff in pairs(buffs_by_index) do
                if buff:template_name() == "adamant_forceful_stacks" then
                    table.insert(indices_to_remove, index)
                end
            end
            for _, index in ipairs(indices_to_remove) do
    ...
    elseif buff_name == "broker_keystone_chemical_dependency_stack" then
        for i = 1, #buffs do
            if buffs[i]:template_name() == "broker_keystone_chemical_dependency_stack" then
                buffs[i]:force_finish()
            end
        end
        local buffs_by_index = buff_extension._buffs_by_index
        if buffs_by_index then
            local indices_to_remove = {}
            for index, buff in pairs(buffs_by_index) do
                if buff:template_name() == "broker_keystone_chemical_dependency_stack" then
                    table.insert(indices_to_remove, index)
                end
            end
            for _, index in ipairs(indices_to_remove) do
