	...
	widgets = {
		{	["setting_id"] = "group_buff_properties",
			...
			["sub_widgets"] = {
				...
				{ -- Slider for Desired Flensing Protocols Buff Stacks
					["setting_id"] = "desired_FP_stacks",
					["type"] = "numeric",
					["default_value"] = 8,
					["range"] = {0, 8},
					["decimals_number"] = 0,
					["title"] = "desired_FP_stacks",
					["tooltip"] = "buff_slider_tooltip"
				},

				{ -- Slider for Desired Static Capacitor Drain Buff Stacks
					["setting_id"] = "desired_SCD_stacks",
					["type"] = "numeric",
					["default_value"] = 24,
					["range"] = {0, 24},
					["decimals_number"] = 0,
					["title"] = "desired_SCD_stacks",
					["tooltip"] = "buff_slider_tooltip"
				},

				{ -- Slider for Desired Keeping Protocol Buff Stacks
					["setting_id"] = "desired_KP_stacks",
					["type"] = "numeric",
					["default_value"] = 30,
					["range"] = {0, 30},
					["decimals_number"] = 0,
					["title"] = "desired_KP_stacks",
					["tooltip"] = "buff_slider_tooltip"
				},
		...
		{	["setting_id"] = "group_buff_toggles",
			...
			["sub_widgets"] = {
				...
				{ -- Toggle FP
					["setting_id"] = "toggle_FP_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle SCD
					["setting_id"] = "toggle_SCD_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle HCC
					["setting_id"] = "toggle_HCC_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle TDI
					["setting_id"] = "toggle_TDI_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle GMA
					["setting_id"] = "toggle_GMA_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle Keeping Protocol
					["setting_id"] = "toggle_KP_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle Forceful Keystone
					["setting_id"] = "toggle_Forceful_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				},
				{ -- Toggle Chemical Dependency
					["setting_id"] = "toggle_CD_buff_handling",
					["type"] = "checkbox",
					["default_value"] = true
				}
