...
if ui_owner._ui_class_RealmsMasteriesOverviewView then
    return ui_owner._ui_class_RealmsMasteriesOverviewView
end
...
local RealmsMasteriesOverviewView = class("RealmsMasteriesOverviewView", "BaseView")

function RealmsMasteriesOverviewView:init(settings, context)
	RealmsMasteriesOverviewView.super.init(self, MasteriesOverviewViewDefinitions, settings, context)
...
function RealmsMasteriesOverviewView:_on_view_load_complete(loaded)
	RealmsMasteriesOverviewView.super._on_view_load_complete(self, loaded)
end

function RealmsMasteriesOverviewView:on_enter()
	RealmsMasteriesOverviewView.super.on_enter(self)
...
function RealmsMasteriesOverviewView:_reset_mastery_data_by_id(id)
...
function RealmsMasteriesOverviewView:_update_mastery_data(mastery_id)
...
function RealmsMasteriesOverviewView:_level_up_mastery(id)
	local mastery = id and self._masteries[id]
...
function RealmsMasteriesOverviewView:_level_up_max_mastery(id)
	local mastery = id and self._masteries[id]
...
function RealmsMasteriesOverviewView:_update_mastery_presentation(optional_mastery_id)
...
function RealmsMasteriesOverviewView:_set_camera_focus(camera_settings)
	for i = 1, #camera_settings do
		Managers.event:trigger(unpack(camera_settings[i]))
	end
end

function RealmsMasteriesOverviewView:_set_button_callbacks()
...
function RealmsMasteriesOverviewView:_setup_layout_entries()
	local layout = {}
...
function RealmsMasteriesOverviewView:_setup_patterns_grid()
...
function RealmsMasteriesOverviewView:cb_on_grid_entry_left_pressed(widget, element)
...
function RealmsMasteriesOverviewView:_update_patterns_grid_position()
...
function RealmsMasteriesOverviewView:_setup_menu_tabs(content)
...
function RealmsMasteriesOverviewView:_switch_tab(index)
	local tabs_content = self._patterns_tabs_content
...
function RealmsMasteriesOverviewView:_present_layout_by_slot_filter(slot_filter, item_type_filter, optional_display_name, optional_callback)
...
function RealmsMasteriesOverviewView:_update_patterns_tab_bar_position()
...
function RealmsMasteriesOverviewView:_cb_on_present(optional_callback)
	local grid_widgets = self._patterns_grid:widgets()
...
function RealmsMasteriesOverviewView:_handle_input(input_service, dt, t)
...
function RealmsMasteriesOverviewView:_on_navigation_input_changed()
	return
end

function RealmsMasteriesOverviewView:draw(dt, t, input_service, layer)
	RealmsMasteriesOverviewView.super.draw(self, dt, t, input_service, layer)
end

function RealmsMasteriesOverviewView:on_resolution_modified(scale)
	RealmsMasteriesOverviewView.super.on_resolution_modified(self, scale)
	self:_update_patterns_grid_position()
	self:_update_patterns_tab_bar_position()
...
function RealmsMasteriesOverviewView:update(dt, t, input_service)
	return RealmsMasteriesOverviewView.super.update(self, dt, t, input_service)
end

function RealmsMasteriesOverviewView:on_exit()
	RealmsMasteriesOverviewView.super.on_exit(self)
end

function RealmsMasteriesOverviewView:_fetch_mastery_data(mastery_id)
...
function RealmsMasteriesOverviewView:_mastery_data_available(mastery_id)
	return self._mastery_milestones[mastery_id] and self._mastery_traits[mastery_id] and self._mastery_marks[mastery_id]
end

function RealmsMasteriesOverviewView:_present_mastery(mastery_id)
	local fetch_promise
...
function RealmsMasteriesOverviewView._get_next_milestone(mastery_data)
	local claimed_level = mastery_data.claimed_level or -1
...
function RealmsMasteriesOverviewView:_get_milestones_data(mastery_id)
...
function RealmsMasteriesOverviewView:_get_marks_data(mastery_id)
	if not mastery_id then
		return
	end
...
function RealmsMasteriesOverviewView:_get_traits_data(mastery_id)
	if not mastery_id then
		return
	end
...
function RealmsMasteriesOverviewView:_set_pattern_icon(mastery_id, is_max_level)
...
ui_owner._ui_class_RealmsMasteriesOverviewView = RealmsMasteriesOverviewView
return RealmsMasteriesOverviewView
