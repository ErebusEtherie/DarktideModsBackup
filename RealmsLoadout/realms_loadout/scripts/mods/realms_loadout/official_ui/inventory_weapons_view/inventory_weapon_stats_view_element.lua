...
if ui_owner._ui_class_RealmsInventoryWeaponStatsViewElement then
    return ui_owner._ui_class_RealmsInventoryWeaponStatsViewElement
end
...
local InventoryWeaponStatsViewElement = class("RealmsInventoryWeaponStatsViewElement", "ViewElementGrid")

function InventoryWeaponStatsViewElement:init(parent, draw_layer, start_scale, optional_menu_settings)
	...
	InventoryWeaponStatsViewElement.super.init(self, parent, draw_layer, start_scale, optional_menu_settings, definitions)
...
function InventoryWeaponStatsViewElement:destroy(ui_renderer)
	InventoryWeaponStatsViewElement.super.destroy(self, ui_renderer)
end
...
function InventoryWeaponStatsViewElement:_verify_weapon(item)
	if not item then
		return false
	end
...
function InventoryWeaponStatsViewElement:present_item(item, context, on_present_callback)
...
function InventoryWeaponStatsViewElement:stop_presenting()
...
function InventoryWeaponStatsViewElement:is_presenting()
	return not not self._item
end

function InventoryWeaponStatsViewElement:present_grid_layout(layout, on_present_callback, item)
	...
	local generate_blueprints_function = require("realms_loadout/scripts/mods/realms_loadout/official_ui/inventory_weapons_view/inventory_item_stats_blueprints")
	local menu_settings = self._menu_settings
	local grid_size = menu_settings.grid_size
	local mask_size = menu_settings.mask_size
	...
	InventoryWeaponStatsViewElement.super.present_grid_layout(self, layout, ContentBlueprints, left_click_callback, right_click_callback, grid_display_name, grow_direction, on_present_callback)
end

function InventoryWeaponStatsViewElement:play_expertise_upgrade_animation(callback)
	return self:_start_animation("on_expertise_upgrade", self._widgets_by_name, nil, callback)
end

function InventoryWeaponStatsViewElement:_on_present_grid_layout_changed(layout, content_blueprints, left_click_callback, right_click_callback, display_name, optional_grow_direction)
	InventoryWeaponStatsViewElement.super._on_present_grid_layout_changed(self, layout, content_blueprints, left_click_callback, right_click_callback, display_name, optional_grow_direction)
...
function InventoryWeaponStatsViewElement:draw(dt, t, ui_renderer, render_settings, input_service)
	self._stored_ui_renderer = ui_renderer

	InventoryWeaponStatsViewElement.super.draw(self, dt, t, ui_renderer, render_settings, input_service)
end

function InventoryWeaponStatsViewElement:update(dt, t, input_service)
	return InventoryWeaponStatsViewElement.super.update(self, dt, t, input_service)
end

function InventoryWeaponStatsViewElement:select_perk(index)
...
function InventoryWeaponStatsViewElement:select_trait(index)
	local widgets = self:widgets()
...
function InventoryWeaponStatsViewElement:preview_perk(index, new_perk)
	local widgets = self:widgets()
...
function InventoryWeaponStatsViewElement:preview_trait(index, new_trait)
	local widgets = self:widgets()
	local update_list_size = false
...
function InventoryWeaponStatsViewElement:update_expertise_value(start_value, override_value)
...
ui_owner._ui_class_RealmsInventoryWeaponStatsViewElement = InventoryWeaponStatsViewElement
return InventoryWeaponStatsViewElement
