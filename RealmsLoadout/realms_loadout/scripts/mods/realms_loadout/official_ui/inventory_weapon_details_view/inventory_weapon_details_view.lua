...
if ui_owner._ui_class_RealmsInventoryWeaponDetailsView then
    return ui_owner._ui_class_RealmsInventoryWeaponDetailsView
end
...
local RealmsInventoryWeaponDetailsView = class("RealmsInventoryWeaponDetailsView", "BaseView")

function RealmsInventoryWeaponDetailsView:init(settings, context)
	self._context = context or {}
	self._visibility_toggled_on = true

	RealmsInventoryWeaponDetailsView.super.init(self, Definitions, settings, context)
...
function RealmsInventoryWeaponDetailsView:on_enter()
	RealmsInventoryWeaponDetailsView.super.on_enter(self)
...
function RealmsInventoryWeaponDetailsView:_setup_debug_weapon_stats(item)
...
function RealmsInventoryWeaponDetailsView:_setup_input_legend()
...
function RealmsInventoryWeaponDetailsView:_toggle_view(id, force_update)
...
function RealmsInventoryWeaponDetailsView:_setup_weapon_info()
...
function RealmsInventoryWeaponDetailsView:_update_weapon_info_position()
	if not self._weapon_info then
		return
	end
...
function RealmsInventoryWeaponDetailsView:_setup_weapon_actions_extended()
...
function RealmsInventoryWeaponDetailsView:_update_weapon_actions_extended_position()
	if not self._weapon_actions_extended then
		return
	end
...
function RealmsInventoryWeaponDetailsView:_setup_attack_patterns()
...
function RealmsInventoryWeaponDetailsView:_update_attack_patterns_position()
	if not self._attack_patterns then
		return
	end
...
function RealmsInventoryWeaponDetailsView:cb_activate_weapon_info(activate)
	self._weapon_info:activate(activate)
end

function RealmsInventoryWeaponDetailsView:_cb_on_close_pressed()
	Managers.ui:close_view("realms_inventory_weapon_details_view")
end

function RealmsInventoryWeaponDetailsView:_setup_default_gui()
	local ui_manager = Managers.ui
	local reference_name = "RealmsInventoryWeaponDetailsView"
	local timer_name = "ui"
...
function RealmsInventoryWeaponDetailsView:_preview_item(item)
...
function RealmsInventoryWeaponDetailsView:_destroy_weapon_preview()
	if self._weapon_preview then
...
function RealmsInventoryWeaponDetailsView:_setup_weapon_preview()
...
function RealmsInventoryWeaponDetailsView:_update_weapon_preview_viewport()
...
function RealmsInventoryWeaponDetailsView:on_back_pressed()
	Managers.ui:close_view("realms_inventory_weapon_details_view")
end

function RealmsInventoryWeaponDetailsView:on_exit()
	...
	if self._ui_default_renderer then
		...
		Managers.ui:destroy_renderer("RealmsInventoryWeaponDetailsView" .. "_ui_default_renderer")
	...
	RealmsInventoryWeaponDetailsView.super.on_exit(self)
end

function RealmsInventoryWeaponDetailsView:_get_weapon_spawn_position_normalized()
...
function RealmsInventoryWeaponDetailsView:_set_weapon_zoom(fraction)
	self._weapon_zoom_fraction = fraction

	self:_update_weapon_preview_viewport()
end

function RealmsInventoryWeaponDetailsView:_is_trait_slot_unlocked(slot_index)
...
function RealmsInventoryWeaponDetailsView:_cb_on_ui_visibility_toggled(id)
...
function RealmsInventoryWeaponDetailsView:_handle_input(input_service, dt, t)
...
function RealmsInventoryWeaponDetailsView:update(dt, t, input_service)
	return RealmsInventoryWeaponDetailsView.super.update(self, dt, t, input_service)
end

function RealmsInventoryWeaponDetailsView:draw(dt, t, input_service, layer)
...
function RealmsInventoryWeaponDetailsView:_draw_elements(dt, t, ui_renderer, render_settings, input_service)
	...
	for i = 1, #elements_array do
		...
		if element then
			...
			ui_renderer = (element_name ~= "ViewElementInventoryWeaponPreview" or element_name ~= "ViewElementInputLegend") and self._ui_default_renderer or ui_renderer
...
function RealmsInventoryWeaponDetailsView:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
	local alpha_multiplier = self._alpha_multiplier or 1
...
function RealmsInventoryWeaponDetailsView:_clear_widgets(widgets)
	if widgets then
		for i = 1, #widgets do
			local widget = widgets[i]
			local widget_name = widget.name
...
function RealmsInventoryWeaponDetailsView:_setup_offscreen_gui()
	local ui_manager = Managers.ui
...
function RealmsInventoryWeaponDetailsView:_destroy_offscreen_gui()
...
function RealmsInventoryWeaponDetailsView:on_resolution_modified(scale)
	RealmsInventoryWeaponDetailsView.super.on_resolution_modified(self, scale)
	self:_update_weapon_preview_viewport()
	self:_update_weapon_actions_extended_position()
	self:_update_weapon_info_position()
	self:_update_attack_patterns_position()
...
function RealmsInventoryWeaponDetailsView:_draw_weapon_stats(ui_renderer, input_service)
...
function RealmsInventoryWeaponDetailsView:_remove_element(reference_name)
...
ui_owner._ui_class_RealmsInventoryWeaponDetailsView = RealmsInventoryWeaponDetailsView
return RealmsInventoryWeaponDetailsView
