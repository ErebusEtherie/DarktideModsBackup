...
local function trait_button_change_function(content, style)
	local hotspot = content.hotspot
	local old_is_selected = hotspot.is_selected

	hotspot.is_selected = hotspot.is_selected or content.marked
	ButtonPassTemplates.terminal_button_change_function(content, style)
	hotspot.is_selected = old_is_selected
end
...
ViewElementTraitInventoryBlueprints.trait = {
	...
	pass_template = {
		...
		},
		{
			...
			change_function = trait_button_change_function
		},
		{
			pass_type = "texture",
			style_id = "frame",
