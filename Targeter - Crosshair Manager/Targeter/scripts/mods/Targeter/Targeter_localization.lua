...
local localizations = {
    ...
    charge_up_ads_larger_dot                = { en = Localize("loc_weapon_family_lasgun_p2_m1") .. " + " .. Localize("loc_setting_crosshair_type_override_dot") .. " (Large)" },
...
localizations.transonic_sword_transonic_knife_class = {
    en = Localize("loc_weapon_family_transonic_sword_transonic_knife_p1_m1")
}
