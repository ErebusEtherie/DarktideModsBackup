...
local _s = mod:io_dofile("peril_tracker/scripts/mods/peril_tracker/history/peril_history_view_settings")
...
local PerilHistoryViewDefinitions = {
    legend_inputs        = legend_inputs,
    widget_definitions   = widget_definitions,
    scenegraph_definition = scenegraph_definition,
}

return settings("PerilHistoryViewDefinitions", PerilHistoryViewDefinitions)
