...
return {
    barrel_attachments = function(default)
        local attachments = {
            ...
            {id = "barrel_06", name = "Heavy Barrel 6"},
            {id = "barrel_07", name = "Heavy Barrel 7"},
        }
    ...
    barrel_models = function(parent, angle, move, remove, type, no_support, automatic_equip, hide_mesh, mesh_move, special_resolve)
        ...
        return table_model_table({
            ...
            {name = "barrel_06",      model = _item_ranged.."/barrels/stubgun_heavy_ogryn_barrel_06"},
            {name = "barrel_07",      model = _item_ranged.."/barrels/stubgun_heavy_ogryn_barrel_ml01"},
    ...
    receiver_attachments = function(default)
        local attachments = {
            ...
            {id = "receiver_05", name = "Heavy Receiver 5"},
            {id = "receiver_06", name = "Heavy Receiver 6"},
            {id = "receiver_07", name = "Heavy Receiver 7"},
        }
        if default == nil then default = true end
        if default then return table_icombine(
    ...
    receiver_models = function(parent, angle, move, remove, type, no_support, automatic_equip, hide_mesh, mesh_move, special_resolve)
        ...
        return table_model_table({
            ...
            {name = "receiver_05",      model = _item_ranged.."/recievers/stubgun_heavy_ogryn_receiver_05"},
            {name = "receiver_06",      model = _item_ranged.."/recievers/stubgun_heavy_ogryn_receiver_06"},
            {name = "receiver_07",      model = _item_ranged.."/recievers/stubgun_heavy_ogryn_receiver_ml01"},
    ...
    magazine_attachments = function(default)
        local attachments = {
            ...
            {id = "magazine_06", name = "Heavy Magazine 6"},
            {id = "magazine_07", name = "Heavy Magazine 7"},
        }
        if default == nil then default = true end
        if default then return table_icombine(
    ...
    magazine_models = function(parent, angle, move, remove, type, no_support, automatic_equip, hide_mesh, mesh_move, special_resolve)
        ...
        return table_model_table({
            ...
            {name = "magazine_06",      model = _item_ranged.."/magazines/stubgun_heavy_ogryn_magazine_06"},
            {name = "magazine_07",      model = _item_ranged.."/magazines/stubgun_heavy_ogryn_magazine_ml01"},
