        ...
        widgets = {
            ...
            -- Auto Ability Activation
            {
                ...
                sub_widgets = {
                    ...
                    -- Venting Shriek Section
                    {
                        setting_id    = "venting_shriek_header",
                        type          = "header",
                        text          = mod:localize("venting_shriek_header"),
                    },
                    {
                        setting_id    = "auto_vent_emergency_enable",
                        type          = "checkbox",
                        default_value = true,
                        text          = mod:localize("auto_vent_emergency_enable"),
                        description   = mod:localize("auto_vent_emergency_enable_description"),
                    },
                    {
                        setting_id      = "auto_vent_emergency_threshold",
                        type            = "numeric",
                        range           = { 0.95, 1.0 },
                        default_value   = 1.0,
                        decimals_number = 2,
                        step_size_value = 0.01,
                        text            = mod:localize("auto_vent_emergency_threshold"),
                        description     = mod:localize("auto_vent_emergency_threshold_description"),
                    },
                    {
                        setting_id    = "auto_vent_optimized_enable",
                        type          = "checkbox",
                        default_value = true,
                        text          = mod:localize("auto_vent_optimized_enable"),
                        description   = mod:localize("auto_vent_optimized_enable_description"),
                    },
                    -- Centin Shriek Section
                    {
                        setting_id    = "centin_shriek_header",
                        type          = "header",
                        text          = mod:localize("centin_shriek_header"),
                    },
                    {
                        setting_id    = "auto_centin_enable",
                        type          = "checkbox",
                        default_value = false,
                        text          = mod:localize("auto_centin_enable"),
                        description   = mod:localize("auto_centin_enable_description"),
                    },
                    {
                        setting_id      = "auto_centin_threshold",
                        type            = "numeric",
                        range           = { 1, 6 },
                        default_value   = 6,
                        decimals_number = 0,
                        step_size_value = 1,
                        text            = mod:localize("auto_centin_threshold"),
                        description     = mod:localize("auto_centin_threshold_description"),
                    },
                },
            },
        },
