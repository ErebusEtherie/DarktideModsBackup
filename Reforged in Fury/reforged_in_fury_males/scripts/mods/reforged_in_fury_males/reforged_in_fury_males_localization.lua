return {
	mod_description = {
		en = " ReforgedInFury  restores 20 Voice lines for the ability Fury of Faithful for each personalities for Zealots and lets you turn on and off the ones you would like to hear!",
	},
	zealot_voice_selection = {
		en = "Voice Lines Selection",
	},
    --Male Agitator
    zealot_voice_selection_male_a = {
        en = "{#color(255,255,255)} {#color(255,255,255)}M{#color(255,235,235)}a{#color(255,215,215)}l{#color(255,195,195)}e {#color(255,175,175)}A{#color(250,150,150)}g{#color(245,125,125)}i{#color(235,100,100)}t{#color(225,75,75)}a{#color(215,50,50)}t{#color(200,30,30)}o{#color(185,15,15)}r {#color(185,15,15)}Voice Lines{#reset()}",
    },
    loc_zealot_male_a__ability_banisher_01 = {
        en = "MASTER BLESS THIS WEAPON!",
    },
    loc_zealot_male_a__ability_banisher_02 = {
        en = "MASTER ANOINT THIS WEAPON!",
    },
    loc_zealot_male_a__ability_banisher_03 = {
        en = "MASTER GRANT ME YOUR WRATH!",
    },
    loc_zealot_male_a__ability_banisher_04 = {
        en = "LET WRATH CONSUME MY FOES!",
    },
    loc_zealot_male_a__ability_banisher_05 = {
        en = "I CALLETH FORTH THE MASTER'S HOLY WRATH!",
    },
    loc_zealot_male_a__ability_banisher_06 = {
        en = "GRANTETH ME BLESSINGS OF FIRE!",
    },
    loc_zealot_male_a__ability_banisher_07 = {
        en = "LET HOLY FLAME PURETH THE FOE!",
    },
    loc_zealot_male_a__ability_banisher_08 = {
        en = "MASTER! GRANT ME YOUR WRATH!",
    },
    loc_zealot_male_a__ability_banisher_09 = {
       en = "FLAME SHALL PURGETH THESE SINNERS!",
    },
    loc_zealot_male_a__ability_banisher_10 = {
        en = "I CALL FORTH REDEMPTOR'S FLAME!",
    },
    ...
    loc_zealot_male_a__ability_banisher_impact_07 = {
        en = "PURGE THE HERETIC, THE MUTANT, THE UNCLEAN!",
    },
    ...
    loc_zealot_male_a__ability_maniac_15 = {
        en = "IN THE MASTER'S NAME!",
    },
    --Male Fanatic
    zealot_voice_selection_male_b = {
        en = "{#color(255,255,255)} {#color(255,255,255)}M{#color(235,255,235)}a{#color(215,255,215)}l{#color(195,255,195)}e {#color(175,255,175)}F{#color(150,250,150)}a{#color(125,245,125)}n{#color(100,235,100)}a{#color(75,225,75)}t{#color(50,215,50)}i{#color(30,200,30)}c {#color(30,200,30)}Voice Lines{#reset()}",
    },
    loc_zealot_male_b__ability_banisher_01 = {
        en = "TASTE HOLY WRATH YE WRETCHES!",
    },
    loc_zealot_male_b__ability_banisher_02 = {
        en = "GOD EMPEROR GRANT ME WRATH!",
    },
    loc_zealot_male_b__ability_banisher_03 = {
        en = "GOD EMPEROR GRANT ME PURGING FLAME!",
    },
    loc_zealot_male_b__ability_banisher_04 = {
        en = "MY WRATH SHALL CLEANSE YE WRETCHES!",
    },
    loc_zealot_male_b__ability_banisher_05 = {
        en = "LETS WRATH GATHER, LET ALL BE CLEANSED!",
    },
    loc_zealot_male_b__ability_banisher_06 = {
        en = "COME SCUNNERS, FEEL THE FLAME!",
    },
    loc_zealot_male_b__ability_banisher_07 = {
        en = "THE GIFT OF HOLY FIRE, REJOICE!",
    },
    loc_zealot_male_b__ability_banisher_08 = {
        en = "BLESSED FLAME, PURGE THESE WRETCHES!",
    },
    ...
    loc_zealot_male_b__ability_maniac_07 = {
        en = "SMITE THE HERETIC!",
    },
    loc_zealot_male_b__ability_maniac_08 = {
        en = "BLOOD FOR THE EMPEROR, SKULLS FOR THE GOLDEN THRONE!",
    },
