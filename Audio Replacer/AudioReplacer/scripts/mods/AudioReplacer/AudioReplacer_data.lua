	...
	widgets = {
		{
			...
			sub_widgets = {
				...
				{
					setting_id    = "precision_stance",
					type          = "checkbox",
					default_value = false,
					sub_widgets   = { --[[...]] } -- optional
				},
				{
					setting_id    = "precision_stance_kill",
					type          = "checkbox",
					default_value = false,
					sub_widgets   = { --[[...]] } -- optional
				},
				{
					setting_id    = "backstab_audio",
					type          = "checkbox",
					default_value = false,
					sub_widgets   = { --[[...]] } -- optional
				},
		...
		},
		{
			...
			sub_widgets = {
				...
				{
					setting_id    = "light_lasgun",
					type          = "checkbox",
					default_value = false,
					sub_widgets   = { --[[...]] } -- optional
				},
				{
					setting_id    = "heavy_lasgun",
					type          = "checkbox",
					default_value = false,
					sub_widgets   = { --[[...]] } -- optional
				},
