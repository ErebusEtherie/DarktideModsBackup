...
mod.version = "Simple Buff Filter version 1.4.5"

--[[
CHANGELOG
1.4.5
-- [Fixed] Localisation for Skitarii force field blitz screen effect (not retroactive)

1.4.4
-- [Fixed] Overrides for Skitarii buffs linked to wrong talents (not retroactive)
-- [Fixed] Localisations for Skitarii power sword charge buffs (not retroactive)
-- [Fixed] Localisation for Skitarii explosion ability screen effect (not retroactive)

1.4.3
-- [Fixed] Corrected icon issue from Skitarii update (thanks to syllogism)
-- [Fixed] Buff bars should no longer be visible on the Mourningstar (reported by jasonjayalap)
