...
local HARDCODED_BUFF_LOCS = {
    ...
    ["melee_power_bonus_scaled_on_special_charges"] = "loc_weapon_keyword_melee_power_bonus_scaled_on_special_charges",
    ["windup_increases_special_power_default_parent"] = "loc_weapon_keyword_heavy_special_windup",
    ...
    ["cryptic_redline_toughness"] = "loc_talent_cryptic_power_generation_one_more_charge", -- They even mixed the loc key up
    ["cryptic_crits_grant_tdr"] = "loc_talent_cryptic_crits_grant_tdr",
    ["cryptic_toughness_on_damage_taken"] = "loc_talent_cryptic_toughness_on_damage_taken",
