...
local HARDCODED_MOOD_LOCS = {
    ...
    -- cryptic
    cryptic_grenade_ability_force_field                                     = "loc_talent_cryptic_grenade_ability_force_field",
    ["content/fx/particles/screenspace/screen_voltaic_emitter_electric"]    = "loc_talent_cryptic_discharge",
}
