...
local Panel = mod:io_dofile("MortisBuffManager/scripts/mods/MortisBuffManager/modules/workspace_panel")
local View = class("MortisBuffManagerWorkspaceNativeView", "InventoryBackgroundView")
